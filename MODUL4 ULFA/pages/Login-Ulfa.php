...
if (isset($_COOKIE["email"]) && isset($_COOKIE["password"])) {
    ...
    $result = mysqli_query($connector, "SELECT * FROM user_ulfa WHERE email = '$email'");
...
<head>
    ...
    <title>LOGIN-AULIA ULFA CHENI-1202204019</title>
                    ...
                    <div class="form-login m-auto ps-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                ...
                                <p class="small fw-bold mt-2 pt-1 mb-0">belum punya akun <a href="Register-Ulfa.php" class="link-primary">Daftar</a></p>
                            </div>
                        </form>
                    </div>
