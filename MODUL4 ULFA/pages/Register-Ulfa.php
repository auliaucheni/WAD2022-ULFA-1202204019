...
if (isset($_POST["daftar"])) {
    ...
    $no_hp = $_POST["no"];
    $result = mysqli_query($connector, "SELECT email FROM user_ulfa WHERE email = '$email'");

    if (mysqli_num_rows(($result)) !== 1 && $password == $pwdConfirm) {
        $password = password_hash($password, PASSWORD_DEFAULT);
        mysqli_query($connector, "INSERT INTO user_ulfa VALUES ('', '$nama', '$email', '$password', '$no_hp')");
        ...
        echo "<meta http-equiv='refresh' content='2 url=Login-Ulfa.php'>";
...
<head>
    <title>REGISTER-AULIA ULFA CHENI-1202204019 </title>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-6 min-vh-100 left">
                    <img src="../asset/images/cheni.jpeg" style="object-fit:fill; width:100%; height:100%;" alt="foto">
                </div>
                <div class="col-md-6">
                    <div class="form-login m-auto ps-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <span class="required" style="top: 0px; left: 41px;">*</span>
                                <input type="nama" id="nama" class="form-control form-control-lg" name="nama" placeholder="nama" required />
                            </div>
                            <!-- no hp input -->
                            <div class="form-outline mb-4">
                                <label class="form-label" for="no">No Hp</label>
                                <span class="required" style="top: 0px; left: 41px;">*</span>
                                <input type="no" id="no" class="form-control form-control-lg" name="no" placeholder="no Hp" required />
                            </div>
                            <!-- Password input -->
                            <div class="form-outline mb-4">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <span class="required" style="top: 0px; left: 41px;">*</span>
                                    <input type="password" id="password2" class="form-control form-control-lg" name="password2" placeholder="ulangi password" required />
                                </div>
                                <div class="text-center text-lg-start mt-4 pt-2">
                                    ...
                                    <p class="small fw-bold mt-2 pt-1 mb-0">anda sudah punya akun? <a href="Login-Ulfa.php" class="link-primary">Login</a></p>
                                </div>
                        </form>
                    </div>
                </div>
