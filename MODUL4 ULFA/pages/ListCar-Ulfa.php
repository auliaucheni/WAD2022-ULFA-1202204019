...
if (isset($_SESSION["login"])) {
  ...
  $result_login = mysqli_query($connector, "SELECT * FROM user_ulfa WHERE email = '$login_as'");
...
<head>
  ...
  <title>LISTCAR-AULIA ULFA CHENI-1202204019</title>
...
<body>
    ...
    <div class="container py-2">
      <?php if (isset($_SESSION["login"])) : ?>
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="./ListCar-Ulfa.php">MyCar</a>
        </div>
        <div class="d-flex">
          <a href="./Add-Ulfa.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" role="button">Add Car</a>
          <div class="dropdown ms-4">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="./Profile-Ulfa.php">Profile</a></li>
      ...
      <?php else : ?>
        <div class="navbar-nav w-100 d-flex justify-content-between">
          ...
          <a class="nav-link" href="./Login-Ulfa.php">Login</a>
        </div>
      <?php endif; ?>
    </div>
  </nav>
  ...
  <section id="list">
    <div class="container">
      <div>
        <h1>My Show Room</h1>
        <p>List Show Room Ulfa - 1202204019</p>
        <div class="d-flex gap-5">
          ...
          if ($checkrow > 0) {
            ...
            <div class='card-body'>
              ...
              <span class='d-flex'>
                <a href='Detail-Ulfa.php?id=" . $hasil["id_mobil"] . "' class='btn btn-primary' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
