...
if (isset($_SESSION["login"])) {
    ...
    header("Location: Login-Ulfa.php");
    exit;
}
...
<body>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>">
        <div class="container py-2">
            <div class="navbar-nav">
                ...
                <a class="nav-link" href="List-Ulfa.php">MyCar</a>
            </div>
            <div class="d-flex">
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center logo-ead">
            ...
            <span class="ms-5 text-muted">Ulfa_1202204019</span>
        </div>
    </div>
