...
<head>
  ...
  <title>DETAIL-AULIA ULFA CHENI-1202204019</title>
    ...
    <div class="container py-2">
      <?php if (isset($_SESSION["login"])) : ?>
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="pages/ListCar-Ulfa.php">MyCar</a>
        </div>
        <div class="d-flex">
          <a href="pages/Add-Ulfa.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" role="button">Add Car</a>
          <div class="dropdown ms-4">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="pages/Profile-Ulfa.php">Profile</a></li>
      ...
      <?php else : ?>
        <div class="navbar-nav w-100 d-flex justify-content-between">
          ...
          <a class="nav-link" href="pages/Login-Ulfa.php">Login</a>
        </div>
      <?php endif; ?>
    </div>
  </nav>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-Ulfa.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
